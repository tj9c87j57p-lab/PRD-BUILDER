# Milestone 1 — Scaffold, Auth & Dashboard Shell
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/1-scaffold-auth-dashboard-shell/milestone-log.md`). Structure it as follows:
