# Milestone 3 — Deals + Kanban Pipeline
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/3-deals-kanban-pipeline/milestone-log.md`). Structure it as follows:
