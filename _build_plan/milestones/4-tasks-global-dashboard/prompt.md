# Milestone 4 — Tasks + Global Dashboard
...
- Read previous milestone folders (`@_build_plan/milestones/1-*/milestone-log.md` through `@_build_plan/milestones/3-*/milestone-log.md`) to understand what has already been built.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/4-tasks-global-dashboard/milestone-log.md`). Structure it as follows:
