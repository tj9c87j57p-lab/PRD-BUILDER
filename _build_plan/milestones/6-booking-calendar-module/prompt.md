# Milestone 6 — Booking / Calendar Module
...
- Read previous milestone folders (`@_build_plan/milestones/1-*/milestone-log.md` through `@_build_plan/milestones/5-*/milestone-log.md`) to understand what has already been built.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/6-booking-calendar-module/milestone-log.md`). Structure it as follows:
...
Note: this milestone requires a Google Cloud project + OAuth client credentials and a one-time consent grant for the admin's Google account, plus the Resend setup from milestone 5 for confirmation/reminder emails. Flag it to the user immediately if any of this is missing before proceeding.
